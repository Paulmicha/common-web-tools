...
# @see cwt/extensions/compose/global.vars.sh
#
# @example
#   # Execute the value of "$DC_SERVICE_EXEC_FALLBACK" (defaults to 'sh') :
#   make se 'foobar-service'
#   # Or :
#   cwt/extensions/compose/service/exec.sh 'foobar-service'
#
#   # Execute what is passed in arg :
#   make se 'foobar-service' 'ls'
#   # Or :
#   cwt/extensions/compose/service/exec.sh 'foobar-service' 'ls'
#
...
#   # Or :
#   cwt/extensions/compose/service/exec.sh \
#     'foobar-service' \

...
#   # Or :
#   cwt/extensions/drupalwt_d4d/remote/d4d_basic_auth.sh
#
#   # Specify target remote instance :
#   make remote-d4d-basic-auth 'stage'
#   # Or :
#   cwt/extensions/drupalwt_d4d/remote/d4d_basic_auth.sh 'stage'
#
...
cwt/extensions/remote/remote/exec.sh "$p_remote_id" \
  cwt/instance/registry_get.sh 'd4d_basic_auth_creds'

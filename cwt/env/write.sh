...
#
# @see cwt/stack/lamp_deb/install.sh
# @see cwt/db/get_credentials.sh
#
# Usage examples :
# . cwt/env/write.sh live myproject.com www.myproject.com
# . cwt/env/write.sh dev myproject.lan-0-40.io
# . cwt/env/write.sh test test.myproject.com
#
